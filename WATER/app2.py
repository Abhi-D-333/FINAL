...
def load_assets():
    ...
    model = joblib.load(os.path.join(base_path, "final_segment_model.pkl"))
    tfidf = joblib.load(os.path.join(base_path, "final_tfidf_vectorizer.pkl"))
    pca = joblib.load(os.path.join(base_path, "final_pca_projection.pkl"))
